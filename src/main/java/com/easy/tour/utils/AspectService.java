...
public class AspectService<T> {
    ...
    // @Before("execution(* com.easy.tour.service.Impl.AbstractBaseServiceImpl.*(..)) && args(dto,...)")

    @Before("execution(* com.easy.tour.service.Impl.AbstractBaseServiceImpl.create(..)) && args(dto)")
    ...
    @Before("execution(* com.easy.tour.service.Impl.AbstractBaseServiceImpl.update(..)) && args(dto)")
    public void beforeUpdate(T dto) {
        this.entity = getEntityService.getByObject(dto);
        this.repository = getRepositoryService.get(this.entity.getClass());
    }

    @Before("execution(* com.easy.tour.service.Impl.AbstractBaseServiceImpl.getAll(..)) && args(dto)")
    public void beforeGetAll(T dto) {
        this.entity = getEntityService.getByObject(dto);
        this.repository = getRepositoryService.get(this.entity.getClass());
    }

    @Before("execution(* com.easy.tour.service.Impl.AbstractBaseServiceImpl.getByID(..)) && args(dto)")
    ...
    @Before("execution(* com.easy.tour.service.Impl.AbstractBaseServiceImpl.delete(..)) && args(dto)")
